# logicplum_batch_scoring
=======================

A script to score CSV files via LogicPlum's prediction API.

[![Coverage](https://coveralls.io/repos/github/LogicPlum/batch-scoring/badge.png?branch=master)](https://coveralls.io/github/LogicPlum/batch-scoring?branch=master)
